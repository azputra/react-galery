    ...
    return (
        ...
        >
            <div className="modal-body-red">
                <button
                    onClick={props.handleCloseModalJingga}
                    type="button"
                                ...
                                <div class="left-content">
                                    ...
                                    <div className="row mt-6">
                                        <div className="col" style={{ width: "100%", padding: "0", height: "100%" }}>
                                            <p className="judul">Dady Suhandi - Tanah Airku</p>
                                            <img className="kotak-img" src={require("../assets/painting/o1.jpg")} alt="" />
                                        </div>
                                    </div>
                                    <div className="row mt-6">
                                        <div className="col" style={{ width: "100%", padding: "0", height: "100%" }}>
                                            <p className="judul">Laraswati Aprillia - Digital Merakyat</p>
                                            <img className="kotak-img" src={require("../assets/painting/o2.jpg")} alt="" />
                                        </div>
                                    </div>
                                    <div className="row mt-6">
                                        <div className="col" style={{ width: "100%", padding: "0", height: "100%" }}>
                                            <p className="judul">Vicky Mile - Bahagia Di Tengah Pandemi</p>
                                            <img className="kotak-img" src={require("../assets/painting/o3.jpg")} alt="" />
                                        </div>
                                    </div>
                                </div>
                            </div>
