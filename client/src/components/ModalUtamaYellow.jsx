        ...
        >
            <div className="modal-body">
                ...
                <div className="row mt-15">
                    ...
                    <div className="col grid-center cropped">
                        <img className="square cursor-pointer" src={painting} onClick={props.handleShowModalKuning} />
                        <h2 className="mt-2_5 text-white cursor-pointer text-title" onClick={props.handleShowModalKuning} >LIVE PAINTING</h2>
                    </div>
                </div>
            </div>
        </div>
