                                ...
                                <div class="left-content">
                                    ...
                                    <div className="row mt-6">
                                        <div className="col" style={{ width: "100%", padding: "0", height: "100%" }}>
                                            <p className="judul">Laily Nur Fitriyah</p>
                                            <img className="kotak-img" src={require("../assets/img/4.1.jpg")} alt="" />
                                        </div>
                                    </div>
                                    <div className="row mt-6">
                                        <div className="col" style={{ width: "100%", padding: "0", height: "100%" }}>
                                            <p className="judul">Laily Nur Fitriyah</p>
                                            <img className="kotak-img" src={require("../assets/img/4.2.jpg")} alt="" />
                                        </div>
                                    </div>
                                    <div className="row mt-6">
                                        <div className="col" style={{ width: "100%", padding: "0", height: "100%" }}>
                                            <p className="judul">Laily Nur Fitriyah</p>
                                            <img className="kotak-img" src={require("../assets/img/4.3.jpg")} alt="" />
                                        </div>
                                    </div>
                                    <div className="row mt-6">
                                        <div className="col" style={{ width: "100%", padding: "0", height: "100%" }}>
                                            <p className="judul">Ahmad Hilmy</p>
                                            <img className="kotak-img" src={require("../assets/img/4.4.jpg")} alt="" />
                                        </div>
                                    </div>
                                    <div className="row mt-6">
                                        <div className="col" style={{ width: "100%", padding: "0", height: "100%" }}>
                                            <p className="judul">Ahmad Hilmy</p>
                                            <img className="kotak-img" src={require("../assets/img/4.5.jpg")} alt="" />
                                        </div>
                                    </div>
                                    <div className="row mt-6">
                                        <div className="col" style={{ width: "100%", padding: "0", height: "100%" }}>
                                            <p className="judul">Ahmad Hilmy</p>
                                            <img className="kotak-img" src={require("../assets/img/4.6.jpg")} alt="" />
                                        </div>
                                    </div>
                                    <div className="row mt-6">
                                        <div className="col" style={{ width: "100%", padding: "0", height: "100%" }}>
                                            <p className="judul">Arya Jodilistyo</p>
                                            <img className="kotak-img" src={require("../assets/img/4.7.jpg")} alt="" />
                                        </div>
                                    </div>
                                    <div className="row mt-6">
                                        <div className="col" style={{ width: "100%", padding: "0", height: "100%" }}>
                                            <p className="judul">Arya Jodilistyo</p>
                                            <img className="kotak-img" src={require("../assets/img/4.8.jpg")} alt="" />
                                        </div>
                                    </div>
                                    <div className="row mt-6">
                                        <div className="col" style={{ width: "100%", padding: "0", height: "100%" }}>
                                            <p className="judul">Arya Jodilistyo</p>
                                            <img className="kotak-img" src={require("../assets/img/4.9.jpg")} alt="" />
                                        </div>
                                    </div>
                                </div>
                            </div>
