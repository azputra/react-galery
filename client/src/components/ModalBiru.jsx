                                ...
                                <div class="left-content">
                                    ...
                                    <div className="row mt-6">
                                        <div className="col" style={{ width: "100%", padding: "0", height: "100%" }}>
                                            <p className="judul">Ayuningtyas - Kaltara Merajut Asa Ibu Pertiwi</p>
                                            <img className="kotak-img" src={require("../assets/painting/b1.jpg")} alt="" />
                                        </div>
                                    </div>
                                    <div className="row mt-6">
                                        <div className="col" style={{ width: "100%", padding: "0", height: "100%" }}>
                                            <p className="judul">Gde Agus - Kita Semua Bisa</p>
                                            <img className="kotak-img" src={require("../assets/painting/b2.jpg")} alt="" />
                                        </div>
                                    </div>
                                    <div className="row mt-6">
                                        <div className="col" style={{ width: "100%", padding: "0", height: "100%" }}>
                                            <p className="judul">Vrendy Luis - Upaya BI Di Tengah Pandemi Demi Kehidupan Yang Harmoni</p>
