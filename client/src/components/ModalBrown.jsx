    ...
    return (
        ...
        >
            <div className="modal-body-red">
                <button
                    onClick={props.handleCloseModalBrown}
                    type="button"
                                ...
                                <div class="left-content">
                                    ...
                                    <div className="row mt-6">
                                        <div className="col" style={{ width: "100%", padding: "0", height: "100%" }}>
                                            <p className="judul">Muh. Saad Fauzi</p>
                                            <img className="kotak-img" src={require("../assets/img/3.1.jpg")} alt="" />
                                        </div>
                                    </div>
                                    <div className="row mt-6">
                                        <div className="col" style={{ width: "100%", padding: "0", height: "100%" }}>
                                            <p className="judul">Muh. Saad Fauzi</p>
                                            <img className="kotak-img" src={require("../assets/img/3.2.jpg")} alt="" />
                                        </div>
                                    </div>
                                    <div className="row mt-6">
                                        <div className="col" style={{ width: "100%", padding: "0", height: "100%" }}>
                                            <p className="judul">Muh. Saad Fauzi</p>
                                            <img className="kotak-img" src={require("../assets/img/3.3.jpg")} alt="" />
                                        </div>
                                    </div>
                                </div>
                            </div>
