    ...
    return (
        ...
        >
            <div className="modal-body-red">
                <button
                    onClick={props.handleCloseModalMerah}
                    type="button"
                                ...
                                <div class="left-content">
                                    ...
                                    <div className="row mt-6">
                                        <div className="col" style={{ width: "100%", padding: "0", height: "100%" }}>
                                            <p className="judul">M.Putra Ramadhan - Qris In Wonderaland</p>
                                            <img className="kotak-img" src={require("../assets/painting/m1.jpg")} alt="" />
                                        </div>
                                    </div>
                                    <div className="row mt-6">
                                        <div className="col" style={{ width: "100%", padding: "0", height: "100%" }}>
                                            <p className="judul">Riza Pramana Putra</p>
                                            <img className="kotak-img" src={require("../assets/painting/m2.jpg")} alt="" />
                                        </div>
                                    </div>
                                    <div className="row mt-6">
                                        <div className="col" style={{ width: "100%", padding: "0", height: "100%" }}>
                                            <p className="judul">Sri Januarti S - BI Digital Ditengah Pandemi</p>
                                            <img className="kotak-img" src={require("../assets/painting/m3.jpg")} alt="" />
                                        </div>
                                    </div>
                                </div>
                            </div>
